<%@ Page Language="C#" AutoEventWireup="true" CodeFile="babyfood.aspx.cs" Inherits="babyfood" %>
...
<body>
    ...
    <table align="center" ><tr><td style ="width:150px">
     ...
     <hr />
        <br />
        Sort by price: &nbsp; &nbsp; &nbsp;
        <asp:CheckBox ID="CBox1" runat="server" Text="400-800" AutoPostBack ="true" OnCheckedChanged="CBox1_CheckedChanged"  />
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        <asp:CheckBox ID="CBox2" runat="server" Text="800-1000" AutoPostBack ="true" OnCheckedChanged="CBox2_CheckedChanged"  />
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <asp:CheckBox ID="CBox3" runat="server" Text="1500-2000" AutoPostBack ="true" OnCheckedChanged="CBox3_CheckedChanged"  />
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <asp:CheckBox ID="CheckBox1" runat="server" Text="2000 and above" AutoPostBack ="true" OnCheckedChanged="CheckBox1_CheckedChanged"  />
        <hr />
        <asp:Panel ID ="pnlProducts" runat ="server" ></asp:Panel></div>
    </form>
</body>
</html>
