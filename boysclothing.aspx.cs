...
public partial class boysclothing : System.Web.UI.Page
{
    connect c;
    ...
    private void sort4()
    {
        if (IsPostBack)
        {
            ...
            {
                c = new connect();
                c.cmd.CommandText = "select * from item where (Price>=2000) and (TypeID=2 and Gender='boys') ";
                adp.SelectCommand = c.cmd;
                ds.Clear();
                adp.Fill(ds, "chk4");
    ...
    private void sort3()
    {
        if (IsPostBack)
        {
            ...
            {
                c = new connect();
                c.cmd.CommandText = "select * from item where (Price>=1000 and Price<=1500) and (TypeID=2 and Gender='boys') ";
                adp.SelectCommand = c.cmd;
                ds.Clear();
                adp.Fill(ds, "chk3");
    ...
    private void sort2()
    {
        if (IsPostBack)
        {
            ...
            {
                c = new connect();
                c.cmd.CommandText = "select * from item where (Price>=800 and Price<=1000) and (TypeID=2 and Gender='boys') ";
                adp.SelectCommand = c.cmd;
                ds.Clear();
                adp.Fill(ds, "chk2");
    ...
    private void sort1()
    {
        if (IsPostBack)
        {
            ...
            {
                c = new connect();
                c.cmd.CommandText = "select * from item where (Price>=400 and Price<=800) and (TypeID=2 and Gender='boys') ";
                adp.SelectCommand = c.cmd;
                ds.Clear();
                adp.Fill(ds, "chk1");
    ...
    private void fillpage()
    {
        ...
        {
            c = new connect();
            c.cmd.CommandText = "select * from item where TypeID=2 and Gender='boys'";
            adp.SelectCommand = c.cmd;
            ds.Clear();
            pnlProducts.Controls.Clear();
            adp.Fill(ds, "itm");
            ...
            {
                Literal no = new Literal();
                no.Text = "NO RECORDS FOUND";
                pnlProducts.Controls.Add(no);
