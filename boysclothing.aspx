<%@ Page Language="C#" AutoEventWireup="true" CodeFile="boysclothing.aspx.cs" Inherits="boysclothing" %>
...
<body>
    ...
    <table align="center" ><tr><td style ="width:150px">
     ...
     <span style="font-family: Segoe UI">Sort by price:&nbsp;</span>
            ...
            &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
            <asp:CheckBox ID="CheckBox1" runat="server" Font-Bold="True" Text="2000 and Above" CssClass="inputs" Width="133px" OnCheckedChanged="CheckBox1_CheckedChanged" AutoPostBack ="true" />
            <hr />
