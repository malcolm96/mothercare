<%@ Page Language="C#" AutoEventWireup="true" CodeFile="boystoys.aspx.cs" Inherits="boystoys" %>
...
<body>
    ...
    <div>
     <table align="center" ><tr><td style ="width:150px">
       ...
       <td style ="width:150px"><asp:ImageButton ID="ImageButton2" runat="server"
          ...
          <td style ="width:150px"><asp:ImageButton ID="ImageButton3"
              ...
              <asp:ImageButton ID="imghelp" runat ="server" ImageUrl ="~/images/questionmarkbutton.png" Height="46px" OnClick="imghelp_Click" />
              </td>
              <td style="width:12px"><asp:ImageButton ID="imgcart" runat ="server" ImageUrl ="~/images/cartimg.jpg" Height="48px" OnClick="imgcart_Click" /></td>
           <td>
        ...
        <tr>
        <td>
        <img src="images\logo.png" alt ="" width="190" height ="54" />
        </td></tr>
        </table>
     ...
     <span style="font-family: Segoe UI">Sort by price:&nbsp;</span>
            &nbsp;<asp:CheckBox
                ID="CBox1" runat="server" Font-Bold="True" Text="400-800" BorderStyle="None" CssClass="inputs" Width="113px" OnCheckedChanged="CBox1_CheckedChanged" AutoPostBack ="true" />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp;
            <asp:CheckBox ID="CBox2" runat="server" Font-Bold="True" Text="800-1000" CssClass="inputs" Width="98px" OnCheckedChanged="CBox2_CheckedChanged" AutoPostBack ="true" />
            &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;<asp:CheckBox
                ID="CBox3" runat="server" Font-Bold="True" Text="1000-1500" Width="102px" CssClass="inputs" OnCheckedChanged="CBox3_CheckedChanged" AutoPostBack ="true"  />
            &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
            <asp:CheckBox ID="CheckBox1" runat="server" Font-Bold="True" Text="1500-3000" CssClass="inputs" Width="103px" OnCheckedChanged="CheckBox1_CheckedChanged" AutoPostBack ="true" />
            <hr />
